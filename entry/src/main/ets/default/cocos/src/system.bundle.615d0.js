...
(function () {
  ...
  console.log('pptest system.bundle 1')
  console.log('pptest system.bundle 1.1.1.1')
  function errMsg(errCode, msg) {
    return (msg || "") + " (SystemJS Error#" + errCode + " " + "https://git.io/JvFET#" + errCode + ")";
  }

  
  console.log('pptest system.bundle 1.1.1.2')
  var hasSymbol = typeof Symbol !== 'undefined';
  console.log('pptest system.bundle 1.1.1.3')
  var hasSelf = typeof self !== 'undefined';
  console.log('pptest system.bundle 1.1.1.4')
  var hasDocument = typeof document !== 'undefined';
  console.log('pptest system.bundle 1.1.1.5')
  
  var envGlobal = hasSelf ? self : global;
  console.log('pptest system.bundle 1.1.1.6')

  var baseUrl;

  console.log('pptest system.bundle 1.1.1')
  if (hasDocument) {
    console.log('pptest system.bundle 1.1.11')
    var baseEl = document.querySelector('base[href]');
    if (baseEl)
      baseUrl = baseEl.href;
  }

  console.log('pptest system.bundle 1.1.2')
  if (!baseUrl && typeof location !== 'undefined') {
    console.log('pptest system.bundle 1.1.22')
  ...
  console.log('pptest system.bundle 1.1.3')
  ...
  console.log('pptest system.bundle 1.1')
  /*
  ...
  console.log('pptest system.bundle 1.2')
  /*
   * SystemJS Core
   * 
   * Provides
  ...
  console.log('pptest system.bundle 1.3')
  ...
  console.log('pptest system.bundle 1.5')
  /*
  ...
  // (function (global) {
    ...
    console.log('pptest system.bundle 1.4.1.1')
    var System = global.System;
    console.log('pptest system.bundle 1.4.1.2')
    setRegisterRegistry(System);
    console.log('pptest system.bundle 1.4.1.3')
    var systemJSPrototype = System.constructor.prototype;
    console.log('pptest system.bundle 1.4.1.4')
    var constructor = System.constructor;
    
    console.log('pptest system.bundle 1.4.1')
    ...
    console.log('pptest system.bundle 1.4.2')
    function setRegisterRegistry(systemInstance) {
      systemInstance.registerRegistry = Object.create(null);
      console.log('pptest system.bundle 1.4.1.2.1')
    }

    console.log('pptest system.bundle 1.4.3')
    ...
    console.log('pptest system.bundle 1.4.4')
    ...
    console.log('pptest system.bundle 1.4.6')
  ...
  // })(global);
  console.log('pptest system.bundle 1.4.7')
  systemJSPrototype.prepareImport = function (_doProcessScripts) { };
  systemJSPrototype.warmup = warmup;
  console.log('pptest system.bundle 1.4.8')
  console.log('pptest system.bundle 3')
}());
